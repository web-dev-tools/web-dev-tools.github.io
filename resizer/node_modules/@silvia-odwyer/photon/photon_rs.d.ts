...
export interface InitOutput {
  ...
  readonly photonimage_get_raw_pixels: (a: number) => Array;
  readonly photonimage_get_height: (a: number) => number;
  readonly photonimage_get_base64: (a: number) => Array;
  readonly photonimage_get_bytes: (a: number) => Array;
  readonly photonimage_get_bytes_jpeg: (a: number, b: number) => Array;
  readonly photonimage_get_bytes_webp: (a: number) => Array;
  readonly photonimage_get_image_data: (a: number) => number;
  readonly photonimage_set_imgdata: (a: number, b: number) => void;
  readonly photonimage_get_estimated_filesize: (a: number) => number;
  ...
  readonly to_raw_pixels: (a: number) => Array;
  readonly base64_to_image: (a: number, b: number) => number;
  readonly base64_to_vec: (a: number, b: number) => Array;
